...
demo_listening_habs.markdown('<div style="text-align: center; font-size: 24px">Impact of Demographics on User Habbits</div>',unsafe_allow_html=True)
...
demo_listening_pref_des_.markdown('<div style="text-align: justify; font-size: 24px">Impact of Demographics on User Preferences</div>',unsafe_allow_html=True)
demo_listening_pref_des_.markdown('<div style="text-align: justify; font-size: 16px"></div>',unsafe_allow_html=True)
