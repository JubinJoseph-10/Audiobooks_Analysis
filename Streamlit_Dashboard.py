...
further_.markdown('<div style="text-align: justify; font-size: 14px">1. The most heard book in {} with {} as {} based on {} is **{}**.</div>'.format(state_name,demograph,demograph_specifc,basis_top_audiobooks,top_book),unsafe_allow_html=True) 
further_.write('\n')
